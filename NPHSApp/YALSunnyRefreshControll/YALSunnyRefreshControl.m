...
static const CGFloat SunTopPoint = 15.f;
static const CGFloat SunBottomPoint = 70.0f;
static const CGFloat SkyTopShift = 30.f;
static const CGFloat SkyDefaultShift = -50.f;

static const CGFloat BuildingDefaultHeight = 72;

static const CGFloat CircleAngle = 360.f;
static const CGFloat BuildingsMaximumScale = 2.8f;
static const CGFloat SunAndSkyMinimumScale = 1.2f;
...
-(void)setupSkyPosition{
    ...
    CGFloat shiftInPercents = [self shiftInPercents];
    CGFloat skyTopConstant = SkyDefaultShift + ((SkyTopShift / 150) * shiftInPercents);
...
-(void)rotateSunInfinitely{
    ...
    if(!self.isSunRotating){
        ...
        rotationAnimation.toValue = @(M_PI * 3);
